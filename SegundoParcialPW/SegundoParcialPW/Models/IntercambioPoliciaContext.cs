...
{
    public partial class IntercambioPoliciaContext : DbContext
    {
        public IntercambioPoliciaContext()
        {
        }

        public IntercambioPoliciaContext(DbContextOptions<IntercambioPoliciaContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Coordenada>(entity =>
            {
                entity.HasKey(e => e.IdCoordenadas)
                    .HasName("PK__coordena__C9F5ED0BDB4BA0B3");
            ...
            modelBuilder.Entity<IntercambioDeDisparo>(entity =>
            {
                entity.HasKey(e => e.IdIntercambio)
                    .HasName("PK__intercam__9444ACDC3771D5C7");
            ...
            modelBuilder.Entity<Participante>(entity =>
            {
                entity.HasKey(e => e.IdParticipantes)
                    .HasName("PK__particip__9451CD96B84D4C14");
